(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("mobx"), require("lodash"), require("pixi.js"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define("lima-core", ["mobx", "lodash", "pixi.js", "react"], factory);
	else if(typeof exports === 'object')
		exports["lima-core"] = factory(require("mobx"), require("lodash"), require("pixi.js"), require("react"));
	else
		root["lima-core"] = factory(root["mobx"], root["_"], root["pixi.js"], root["React"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_99__, __WEBPACK_EXTERNAL_MODULE_209__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_cross__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_descending__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_histogram__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_max__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_mean__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_median__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_merge__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_permute__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_scan__ = __webpack_require__(126);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__src_shuffle__ = __webpack_require__(127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_sum__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_zip__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_round__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_zoom__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_quantize__ = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tickFormat__ = __webpack_require__(168);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__range__ = __webpack_require__(62);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_defaultLocale__ = __webpack_require__(134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_precisionFixed__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_precisionPrefix__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_precisionRound__ = __webpack_require__(142);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatDefault__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatPrefixAuto__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatRounded__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatGroup__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatNumerals__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formatSpecifier__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__formatTypes__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__formatPrefixAuto__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__identity__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_isoFormat__ = __webpack_require__(85);
...
var ViewModelCollection = (_class = function () {
	function ViewModelCollection(models, template) {
		var _this = this;

		_classCallCheck(this, ViewModelCollection);

		_initDefineProp(this, 'viewModels', _descriptor, this);

		this.viewModelMap = new Map();
		this.template = template;

		(0, _mobx.observe)(models, function (e) {
			// housekeeping
			e.added.forEach(function (item) {
				// console.log("++", item)
				_this.viewModels.push(_this.viewModelForObject(item));
			});

			e.removed.forEach(function (item) {
				// console.log("--", item)
				_this.viewModels.splice(_this.viewModels.indexOf(_this.viewModelMap.get(item)), 1);
			});
		}, true);
	}

	_createClass(ViewModelCollection, [{
		key: 'viewModelForObject',
		value: function viewModelForObject(o) {
			var m = this.viewModelMap.get(o);
			if (!m) {
		...
		key: 'makeViewModel',
		value: function makeViewModel(o) {
			return (0, _mobx.extendObservable)({
				// update function to assign new values
				update: (0, _mobx.action)(function (o) {
					(0, _lodash.assign)(this, o);
				}),
				__data: o,
				id: o.id
			}, this.template);
...
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'viewModels', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return [];
	}
})), _class);
exports.default = ViewModelCollection;
...
exports.default = function () {
	if ((typeof viewState === 'undefined' ? 'undefined' : _typeof(viewState)) == undefined) {
		viewState = new _State2.default();

		(0, _mobx.extendObservable)(viewState, {
			position: [0, 0],
			scale: [1, 1],
			rotation: 0,
			pivot: [0, 0]
...
var _Vic = __webpack_require__(213);
...
var DEFAULT_OPTIONS = {
  ...
  elHeight: 0,
  validScaleRange: [1, 1],
  validScaleHardRange: [0.9, 1.1],
  maxPanOverdraft: 50,
  SNAP_BACK_TIME: 1
};

var Camera = function () {
  function Camera(_viewState) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, Camera);

    this.scaleRange = [0, 1];
    this.slowResetTime = 1000;

    this.viewState = _viewState;

    this.options = Object.assign(DEFAULT_OPTIONS, options);

    this.options.validWidth = this.options.elWidth;
    this.options.validHeight = this.options.elHeight;

    this.position = new _Vic.Point(this.viewState.position[0], this.viewState.position[1]);
    this.scale = new _Vic.Point(this.viewState.scale[0], this.viewState.scale[1]);
    this.rotation = this.viewState.rotation;
    this.pivot = new _Vic.Point(this.viewState.pivot[0], this.viewState.pivot[1]);

    // store how much of the translation is part of scaling around points:
    // (we need that to properly calculate parallax, see App.jsx)
    this.scaleOffset = [0, 0];
    this.scaleOvershoot = [0, 0];
  ...
  _createClass(Camera, [{
    key: 'initObserving',
    value: function initObserving() {
      var _this = this;

      (0, _mobx.autorun)(function () {
        _this.stopTweens();

        var tweenDuration = _this.viewState.tweenDuration;
        var tweenEasing = _this.viewState.tweenEasing;

        if (tweenDuration > 0) {

          var targetPosition = {
            x: _this.viewState.position[0],
            y: _this.viewState.position[1]
          };
          var targetScale = {
            x: _this.viewState.scale[0],
            y: _this.viewState.scale[1]
          };

          if (tweenEasing) {
            targetPosition.ease = tweenEasing;
            targetScale.ease = tweenEasing;
          }

          _this.tweens = [_gsap.TweenMax.to(_this.position, tweenDuration, targetPosition), _gsap.TweenMax.to(_this.scale, tweenDuration, targetScale)];
        } else {
          if (_this.viewState.position) {
            _this.position.set(_this.viewState.position[0], _this.viewState.position[1]);
          }
          if (_this.viewState.scale) {
            _this.scale.set(_this.viewState.scale[0], _this.viewState.scale[1]);
          }

          //console.log(`(${this.position.x.toFixed(0)}, ${this.position.y.toFixed(0)}) @ ${this.scale.x.toFixed(1)}`);
        }

        if (_this.viewState.rotation) {
          _this.rotation = _this.viewState.rotation;
        }
        if (_this.viewState.pivot) {
          _this.pivot.set(_this.viewState.pivot[0], _this.viewState.pivot[1]);
        }
      });
    }

    // returns a  matrix from the current coordinates

  }, {
    key: 'convertDisplayPointToLocal',
    value: function convertDisplayPointToLocal(_x, _y) {
      // convert to local coordinate system:
      // (PIXI container is hardcoded to 1920x1080 but we might not have that)
      _x /= SCALE;
      _y /= SCALE;

      // convert to view's coordinate system:
      var relative = this.matrix.applyInverse(new _Vic.Point(_x, _y));
      //let relative = this.view.toLocal(new Point(_x, _y));
      var relativeX = relative.x;
      var relativeY = relative.y;

      //console.log(`@(${_x},${_y}) => (${relativeX},${relativeY})`);

      return new _Vic.Point(relativeX, relativeY);
    }
  }, {
    key: 'moveBy',
    value: function moveBy(_x, _y) {
      var _this2 = this;

      var checkForViolations = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      ...
      if (checkForViolations) {
        ...
        var matrix = new _Vic.Matrix();
        matrix.scale(this.scale.x, this.scale.y);
        //matrix.scale(this.viewState.scale[0], this.viewState.scale[1]);
        matrix.translate(this.position.x + _x, this.position.y + _y);
        //matrix.translate(this.viewState.position[0] + _x, this.viewState.position[1] + _y);

        var validPos = this.checkForPanViolations(matrix);
        //let targetPos = [this.viewState.position[0] + _x, this.viewState.position[1] + _y];
        var targetPos = [this.position.x + _x, this.position.y + _y];

        if (validPos[0] != targetPos[0]) {
          var overPan = Math.abs(targetPos[0] - validPos[0]);

          // scale is approaching the hard limits linearly:
          var jellyScale = (0, _d3Scale.scaleLinear)().domain([0, this.options.maxPanOverdraft]).range([0.5, 0]).clamp(true);

          _x *= jellyScale(overPan);
        }
        if (validPos[1] != targetPos[1]) {
          var _overPan = Math.abs(targetPos[1] - validPos[1]);

          // scale is approaching the hard limits linearly:
          var _jellyScale = (0, _d3Scale.scaleLinear)().domain([0, this.options.maxPanOverdraft]).range([0.5, 0]).clamp(true);

          _y *= _jellyScale(_overPan);
        }
      }

      (0, _mobx.runInAction)(function () {
        _this2.viewState.position = [_this2.position.x + _x, _this2.position.y + _y];
        _this2.viewState.scale = [_this2.scale.x, _this2.scale.y];
        _this2.viewState.tweenDuration = 0;
      });
    ...
    key: 'scaleBy',
    value: function scaleBy(_s) {
      var _this3 = this;

      this.stopTweens();

      var s = this.scale.x * _s;
      s = Math.max(this.options.validScaleRange[0], s);
      s = Math.min(this.options.validScaleRange[1], s);

      (0, _mobx.runInAction)(function () {
        _this3.viewState.position = [_this3.position.x, _this3.position.y];
        _this3.viewState.scale = [s, s];
        _this3.viewState.tweenDuration = 0;
      });
    ...
    key: 'setPivotPoint',
    value: function setPivotPoint(_x, _y) {
      var _this4 = this;

      //let relative = this.convertDisplayPointToLocal(_x, _y)
      var relative = new _Vic.Point(_x / SCALE - this.position.x, _y / SCALE - this.position.x);

      // if(relative.x < 0 || relative.x > this.options.elWidth || relative.y < 0 || relative.y > this.options.elHeight){
      //   debugger
      // }

      //let relative = new Point(_x, _y);

      (0, _mobx.runInAction)(function () {
        _this4.viewState.pivot = [relative.x, relative.y];
        _this4.viewState.tweenDuration = 0;
      });

      this.dirty = true;
    }
  }, {
    key: 'checkForPanViolations',
    value: function checkForPanViolations() {
      var matrix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.matrix;

      var origin = matrix.apply(new _Vic.Point());
      var corner = matrix.apply(new _Vic.Point(this.options.validWidth, this.options.validHeight));

      var validPos = [matrix.tx, matrix.ty];

      if (origin.x > 0 || corner.x < this.options.elWidth) {
        // find closest valid point
        var distLeftBorder = Math.abs(origin.x - 0);
        var distRightBorder = Math.abs(this.options.elWidth - corner.x);

        if (distLeftBorder < distRightBorder) {
          validPos[0] = 0;
        } else {
          validPos[0] = origin.x + (this.options.elWidth - corner.x);
        }
      }
      if (origin.y > 0 || corner.y < this.options.elHeight) {
        // find closest valid point
        var distTopBorder = Math.abs(origin.y - 0);
        var distBottomBorder = Math.abs(this.options.elHeight - corner.y);

        if (distTopBorder < distBottomBorder) {
          validPos[1] = 0;
        } else {
          validPos[1] = origin.y + (this.options.elHeight - corner.y);
        }
      }
    ...
    key: 'scaleFromPointBy',
    value: function scaleFromPointBy(_x, _y, _s) {
      var _this5 = this;

      this.stopTweens();

      var relative = this.convertDisplayPointToLocal(_x, _y);

      var originalScale = this.scale.x;

      var LIMITS = [Math.min(this.options.validScaleRange[0], originalScale), Math.max(this.options.validScaleRange[1], originalScale)];

      var targetS = originalScale * _s;
      var s = targetS;
      s = Math.max(LIMITS[0], s);
      s = Math.min(LIMITS[1], s);

      // cut off targetS at hard limits:
      targetS = Math.max(this.options.validScaleHardRange[0], targetS);
      targetS = Math.min(this.options.validScaleHardRange[1], targetS);

      // store overshoot (i.e., how far the background has moved due to an illicit zoom)
      // for later soft correction:
      var overS = 0;
      if (targetS < LIMITS[0] || targetS > LIMITS[1]) {
        var shrinkFactor = 1;
        var whichLimit = 0;
        if (targetS < LIMITS[0]) {
          whichLimit = 0;
        ...
        overS = targetS - LIMITS[whichLimit];

        // scale is approaching the hard limits logarithmically:
        var jellyScale = (0, _d3Scale.scaleLog)().domain([this.options.validScaleRange[whichLimit], this.options.validScaleHardRange[whichLimit]]).range([0.5, 0]);

        overS *= jellyScale(targetS);

        shrinkFactor = overS + s - this.options.validScaleRange[whichLimit];

        this.scaleOvershoot = [relative.x * shrinkFactor, relative.y * shrinkFactor];
      }

      var scalechange = overS + s - originalScale;

      this.moveBy(-(relative.x * scalechange), -(relative.y * scalechange), false);

      this.scaleOffset = [this.scaleOffset[0] - relative.x * scalechange, this.scaleOffset[1] - relative.y * scalechange];

      (0, _mobx.runInAction)(function () {
        _this5.viewState.position = [_this5.position.x, _this5.position.y];
        _this5.viewState.scale = [overS + s, overS + s];
        _this5.viewState.tweenDuration = 0;
      });
    ...
    key: 'calcZoomToShowRect',
    value: function calcZoomToShowRect(xExtent, yExtent, middle) {
      if (!middle) {
        middle = {
          x: (0, _d3Array.mean)(xExtent),
          y: (0, _d3Array.mean)(yExtent)
        };
      }
      var scale = void 0;
      var maxXDist = (0, _d3Array.max)([Math.abs(xExtent[0] - middle.x), Math.abs(xExtent[1] - middle.x)]);
      var maxYDist = (0, _d3Array.max)([Math.abs(yExtent[0] - middle.y), Math.abs(yExtent[1] - middle.y)]);
      scale = 1 / Math.max(maxXDist / (this.options.elWidth / 2), maxYDist / (this.options.elHeight / 2));
      scale *= .95;

      scale = Math.min(scale, SCALE_RANGE[1] - .1);
      scale = Math.max(scale, SCALE_RANGE[0]);

      return { scale: scale, middle: middle };
    }
  }, {
    key: 'slowReset',
    value: function slowReset() {
      this.flyTo(this.options.elWidth / 2, this.options.elHeight / 2, 1, this.slowResetTime);
    }
  }, {
    key: 'flyTo',
    value: function flyTo(_x, _y, scale) {
      var duration = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : FLY_TIME;

      console.log("flyTo", _x, _y, scale, duration);
      scale = scale || this.scale.x;
      this.tweenTo([-_x * scale + this.options.elWidth / 2, -_y * scale + this.options.elHeight / 2], [scale, scale], duration, Power1.easeInOut);
    }
  }, {
    key: 'tweenTo',
    value: function tweenTo(_position) {
      var _scale = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [1, 1];
      ...
      //console.log(`tween (${_position[0].toFixed(0)}, ${_position[1].toFixed(1)}), scale (${_scale[0].toFixed(1)}, ${_scale[1].toFixed(1)}),  duration = ${duration}`);

      this.stopTweens();

      (0, _mobx.runInAction)(function () {
        _this6.viewState.tweenDuration = duration;
        _this6.viewState.tweenEasing = ease;
        _this6.viewState.position = _position;
        _this6.viewState.scale = _scale;
      });
    }
  }, {
    key: 'cleanUp',
    value: function cleanUp() {
      ...
      this.viewState.tweenDuration = 0;

      var matrix = this.matrix;

      var fixScale = function fixScale(targetScale) {
        var validScale = [targetScale, targetScale];
        _gsap.TweenMax.to(_this7.viewState.scale, _this7.options.SNAP_BACK_TIME, validScale);

        var validScaleOffset = [_this7.scaleOffset[0] + _this7.scaleOvershoot[0], _this7.scaleOffset[1] + _this7.scaleOvershoot[1]];
        _gsap.TweenMax.to(_this7.scaleOffset, _this7.options.SNAP_BACK_TIME, validScaleOffset);

        var validPos = [_this7.viewState.position[0] + _this7.scaleOvershoot[0], _this7.viewState.position[1] + _this7.scaleOvershoot[1]];
        _gsap.TweenMax.to(_this7.viewState.position, _this7.options.SNAP_BACK_TIME, validPos);

        _this7.scaleOvershoot = [0, 0];

        // adapt the transformation matrix accordingly
        matrix = new _Vic.Matrix();
        matrix.scale(validScale[0], validScale[1]);
        matrix.translate(validPos[0], validPos[1]);
      };

      // snap back:
      var s = this.viewState.scale[0];
      if (s < this.options.validScaleRange[0]) {
        fixScale(this.options.validScaleRange[0]);
      } else if (s > this.options.validScaleRange[1]) {
        fixScale(this.options.validScaleRange[1]);
      }

      // check for pan violations:
      var validPos = this.checkForPanViolations(matrix);

      if (validPos[0] != this.viewState.position[0] || validPos[1] != this.viewState.position[1]) {
        _gsap.TweenMax.to(this.viewState.position, this.options.SNAP_BACK_TIME, validPos);
      }
    ...
    key: 'rotateBy',
    value: function rotateBy(_r) {
      this.viewState.rotation += _r;
    }
  }, {
    key: 'rotateFromPointBy',
    value: function rotateFromPointBy(_x, _y, _r) {
      var localPoint = this.convertDisplayPointToLocal(_x, _y);
      //let localPoint = new Point(_x, _y);
      this.viewState.pivot = [localPoint.x, localPoint.y];
      this.viewState.position = this.viewState.pivot;
      // this.viewState.position = [
      //   localPoint.x - this.options.elWidth/2,
      //   localPoint.y - this.options.elHeight/2
      // ];
      this.rotateBy(_r);

      console.log(localPoint.x + ', ' + localPoint.y + ', r ' + this.viewState.rotation);
    }
  }, {
    key: 'toString',
    value: function toString() {
      return 'cam (' + this.position.x + ', ' + this.position.y + ')@' + this.scale.x;
    }
  }, {
    key: 'matrix',
    get: function get() {
      ...
      // transformation order is Scale, then Rotate, then Translate
      matrix.scale(this.scale.x, this.scale.y);
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //import DebugSprite from 'debug/DebugSprite';
//import {addToDebugOverlay, removeFromDebugOverlay} from 'debug/DebugOverlay';


var _RnT = __webpack_require__(112);

var _RnT2 = _interopRequireDefault(_RnT);
...
var InteractionScheme = function () {
  function InteractionScheme(_camera /*, origin*/) {
    _classCallCheck(this, InteractionScheme);
  ...
  _createClass(InteractionScheme, [{
    key: 'receivedEventData',
    value: function receivedEventData(evt) {
      //console.log(evt);
    }
  }, {
    key: 'mapPositionToStage',
    value: function mapPositionToStage(el, x, y) {
      /*let rect = el.getBoundingClientRect();
      let result = {
        x: (x - rect.left) * (rect.width / el.width),
        y: (y - rect.top) * (rect.height / el.height)
      };
      console.log(el);
      console.log(rect);
      ...
      */
      ...
      var bodyZoom = +document.body.style['zoom'] || 1;
      var appZoom = +document.querySelector('#app').style['zoom'] || 1;

      var result = {
        x: (x - config.O_LEFT * appZoom * bodyZoom) / bodyZoom / appZoom,
        y: (y - config.O_TOP * appZoom * bodyZoom) / bodyZoom / appZoom
      };
    ...
    value: function checkTouches(e) {
      ...
      // send out to event stream (to stop idle mode etc.)
      //this.eventStream.handleAndSendTouches(d3.event, this.origin);
      ...
      if (currentTouches) {
        (function () {
          ...
          for (var i = 0; i < currentTouches.length; i++) {
            ...
            var stagePosition = _this.mapPositionToStage(currentEl, stageTouch.x, stageTouch.y);
            stageTouch.stageX = stagePosition.x;
            stageTouch.stageY = stagePosition.y;
            touchArray.push(stageTouch);
          }
          /*
                if(currentTouches.length > 0 && touchArray.length > 0){
                  console.log(`${currentTouches[0].x}, ${currentTouches[0].pageY} => ${touchArray[0].pageX}, ${touchArray[0].pageY}`);
                }
          */

          var allIds = touchArray.map(function (d) {
            return "" + d.identifier;
          });
          var touchesById = _.keyBy(touchArray, function (d) {
            return "" + d.identifier;
          });
          var enter = _.filter(allIds, function (d) {
            return !_this.touches[d];
          });
          var update = _.filter(allIds, function (d) {
            return _this.touches[d];
          });
          var exit = _.filter(_.keys(_this.touches), function (d) {
            return allIds.indexOf(d) == -1;
          });

          // enter
          enter.forEach(function (tId) {
            _this.touches[tId] = {
              prevX: undefined,
              prevY: undefined,
              x: touchesById[tId].x,
              y: touchesById[tId].y,
              stageX: touchesById[tId].stageX,
              stageY: touchesById[tId].stageY
            };

            // add a debug element to stage
            //this.touchSprites[tId] = new DebugSprite(this.touches[tId]);
            //addToDebugOverlay(this.touchSprites[tId]);
          });

          // update
          update.forEach(function (tId) {
            var _prevX = _this.touches[tId].x;
            var _prevY = _this.touches[tId].y;
            ...
            // update debug sprite
            //this.touchSprites[tId].updateData(this.touches[tId]);
          });

          // exit
          exit.forEach(function (tId) {
            delete _this.touches[tId];

            // remove debug sprite
            //removeFromDebugOverlay(this.touchSprites[tId]);
            //delete this.touchSprites[tId];
          });

          (0, _RnT2.default)(_this.touches, enter, update, exit, _this.camera);

          // clean up once all fingers are gone
          if (allIds.length == 0) {
    ...
    value: function initInteractionHandlers() {
      var _this2 = this;

      // touch:
      var touchstart = function touchstart(e) {
        _this2.checkTouches(e);
      };
      ...
      var mousewheel = function mousewheel(e) {
        // send out to event stream (to stop idle mode etc.)
        //this.eventStream.handleAndSendMouse(d3.event, this.origin);
        var wheelDelta = e.deltaY;

        var scaleFactor = 1 + wheelDelta / 1000;
        _this2.camera.scaleFromPointBy(e.x, e.y, scaleFactor);
        e.preventDefault();

        // detect mouse wheel end:
        clearTimeout(_scrollTimeout);
        _scrollTimeout = setTimeout(function () {
          _this2.camera.cleanUp();
        }, 100);
      };
      ...
      var mousemove = function mousemove(e) {
        if (_mouseIsDown) {
          ...
          _this2.camera.moveBy(diff.x, diff.y);
          lastMouseX = x;
          lastMouseY = y;
        }
      };
    ...
    key: 'getInteractionHandlers',
    value: function getInteractionHandlers() {
...
exports.default = InteractionScheme;
...
exports.default = function (touches, enter, update, exit, camera) {
	if (update.length >= 1) {
		(function () {
			var points = [];
			for (var p in update) {
				points.push(touches[update[p]]);
			}
			...
			newCenter.x /= points.length;
			newCenter.y /= points.length;

			var translateBy = new PIXI.Point(newCenter.x - center.x, newCenter.y - center.y);
			...
			if (update.length > 1) {
				(function () {
					...
					var rotationCenter = center;

					points.forEach(function (p) {
						var p1 = {
							x: p.x - rotationCenter.x,
							y: p.y - rotationCenter.y
						};
						var p2 = {
							x: p.prevX - rotationCenter.x,
							y: p.prevY - rotationCenter.y
						};

						var angleDiff = (0, _Vic.angleBetween)(p1, p2);

						rotationAngles.push(angleDiff);

						// distance from center
						var p1_dist = Math.sqrt(Math.pow(p1.x, 2) + Math.pow(p1.y, 2));
						var p2_dist = Math.sqrt(Math.pow(p2.x, 2) + Math.pow(p2.y, 2));

						scales.push(p1_dist / p2_dist);
					});

					if (ROTATION_ENABLED) {
						var rotationSum = _.reduce(rotationAngles, function (sum, n) {
							return sum + n;
						}, 0);
						rotationSum /= rotationAngles.length;

						// NOT WORKING ATM:
						camera.rotateFromPointBy(center.x, center.y, -rotationSum);
					}

					var scaleSum = _.reduce(scales, function (sum, n) {
						return sum + n;
					}, 0);
					scaleSum /= scales.length;

					camera.scaleFromPointBy(center.x, center.y, scaleSum);
					//camera.scaleBy(scaleSum);
				})();
			}

			camera.moveBy(translateBy.x, translateBy.y);
		})();
	}
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constant__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__extent__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__identity__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ticks__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__threshold_sturges__ = __webpack_require__(63);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__decompose__ = __webpack_require__(149);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_band__ = __webpack_require__(154);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_identity__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_log__ = __webpack_require__(161);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_pow__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_quantile__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_quantize__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_threshold__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_utcTime__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_category10__ = __webpack_require__(155);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_category20b__ = __webpack_require__(157);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_category20c__ = __webpack_require__(158);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_category20__ = __webpack_require__(156);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_cubehelix__ = __webpack_require__(159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_rainbow__ = __webpack_require__(165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_viridis__ = __webpack_require__(170);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_sequential__ = __webpack_require__(166);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isoFormat__ = __webpack_require__(85);
				...
				this.check = function(init) {
					...
					if (missing === 0 && func) {
						...
						if (global) {
							...
							if (!hasModule && "function" === "function" && __webpack_require__(51)){ //AMD
...
exports.viewState = exports.InteractivePixiView = exports.PixiView = exports.ViewModelCollection = undefined;

var _ViewModelCollection2 = __webpack_require__(105);

var _ViewModelCollection3 = _interopRequireDefault(_ViewModelCollection2);

var _PixiView2 = __webpack_require__(217);

var _PixiView3 = _interopRequireDefault(_PixiView2);

var _InteractivePixiView2 = __webpack_require__(218);

var _InteractivePixiView3 = _interopRequireDefault(_InteractivePixiView2);

var _getViewState = __webpack_require__(107);

var _getViewState2 = _interopRequireDefault(_getViewState);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.ViewModelCollection = _ViewModelCollection3.default;
exports.PixiView = _PixiView3.default;
exports.InteractivePixiView = _InteractivePixiView3.default;


var viewState = (0, _getViewState2.default)();
...
/**
 * Creates a pixi stage as a React component.
 * 
 */
var PixiComponent = (_class = function (_Component) {
  _inherits(PixiComponent, _Component);
  ...
  function PixiComponent(props) {
    ...
    _initDefineProp(_this, 'ready', _descriptor, _this);
  ...
  _createClass(PixiComponent, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.pixiOptions) {
        Object.assign(options, this.props.pixiOptions);
      }

      this.app = new PIXI.Application(dimensions.width, dimensions.height, options);
    ...
    value: function init() {
      ...
      console.log('initing stage component');
      if (window.hasOwnProperty('lima')) {
        window.lima.mainLoop.hook(function (elapsed) {
          _this2.update(elapsed);
        });
        this.ready = true;
      } else {
        console.error('could not initialize StageComponent - window.lima is missing. Is lima/core imported?');
      }
    }
  }, {
    key: 'update',
...
}(_React.Component), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'ready', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
...
var _InteractionScheme = __webpack_require__(111);

var _InteractionScheme2 = _interopRequireDefault(_InteractionScheme);
...
var InteractivePixiView = function (_PixiView) {
	_inherits(InteractivePixiView, _PixiView);

	function InteractivePixiView(props) {
		_classCallCheck(this, InteractivePixiView);

		var _this = _possibleConstructorReturn(this, (InteractivePixiView.__proto__ || Object.getPrototypeOf(InteractivePixiView)).call(this, props));

		if (props.hasOwnProperty('viewState')) {
			if (props.hasOwnProperty('cameraOptions')) {
				_this.camera = new _Camera2.default(props.viewState, props.cameraOptions);
			} else {
				_this.camera = new _Camera2.default(props.viewState);
			}

			_this.interaction = new _InteractionScheme2.default(_this.camera);
		}
		return _this;
	}

	_createClass(InteractivePixiView, [{
		key: 'initInteraction',
		value: function initInteraction() {
			var _this2 = this;

			this.interactionHandlers = this.interaction.getInteractionHandlers();

			this.el.addEventListener('touchstart', function (e) {
				_this2.interactionHandlers['touchstart'].call(_this2, e);
			});
			this.el.addEventListener('touchmove', function (e) {
				_this2.interactionHandlers['touchmove'].call(_this2, e);
			});
			this.el.addEventListener('touchend', function (e) {
				_this2.interactionHandlers['touchend'].call(_this2, e);
			});
			this.el.addEventListener('mousedown', function (e) {
				_this2.interactionHandlers['mousedown'].call(_this2, e);
			});
			this.el.addEventListener('mousemove', function (e) {
				_this2.interactionHandlers['mousemove'].call(_this2, e);
			});
			this.el.addEventListener('mouseup', function (e) {
				_this2.interactionHandlers['mouseup'].call(_this2, e);
			});
			this.el.addEventListener('wheel', function (e) {
				_this2.interactionHandlers['mousewheel'].call(_this2, e);
			});
		}
	}, {
		key: 'componentDidMount',
		value: function componentDidMount() {
			...
			_get(InteractivePixiView.prototype.__proto__ || Object.getPrototypeOf(InteractivePixiView.prototype), 'componentDidMount', this).call(this);
		}
	}, {
		key: 'update',
		value: function update(elapsed) {
			// update camera:
			if (this.hasOwnProperty('camera')) {
				this.stage.position = this.camera.position;
				this.stage.scale = this.camera.scale;
				this.stage.pivot = this.camera.pivot;
				this.stage.rotation = this.camera.rotation;
			}

			_get(InteractivePixiView.prototype.__proto__ || Object.getPrototypeOf(InteractivePixiView.prototype), 'update', this).call(this, elapsed);
		}
	}]);

	return InteractivePixiView;
}(_PixiView3.default);

exports.default = InteractivePixiView;
