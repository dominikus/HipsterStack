(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("lima-core", ["mobx"], factory);
	else if(typeof exports === 'object')
		exports["lima-core"] = factory(require("mobx"));
	else
		root["lima-core"] = factory(root["mobx"]);
...
var binary = __webpack_require__(202);
...
exports.default = function (state, config) {
	var room = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;

	var BACKEND_HOST = config.BACKEND_HOST || DEFAULT_HOST;
	var BACKEND_PORT = config.BACKEND_PORT || DEFAULT_PORT;
	var BACKEND_ROOM = room || config.BACKEND_ROOM || DEFAULT_ROOM;

	var url = BACKEND_HOST + ':' + BACKEND_PORT;
	...
	socket.on("connect", function (data) {
		...
		// join room:
		socket.emit('room', { room: BACKEND_ROOM });
	});
	...
	(0, _mobx.autorunAsync)(function () {
		var encodedState = state.encoded;

		if (Object.keys(encodedState).length == 0) {
			// ignore
			// TODO: Why? When would this happen? And why is it a problem?
		} else {
			encodedState.timestamp = Date.now();

			// console.log("emitting state", encodedState);
			socket.emit("stateChange", encodedState);
		}
	}, SYNC_DELAY);
};
...
var DEFAULT_HOST = 'dominiku.indus.uberspace.de';
var DEFAULT_PORT = 62833;
var DEFAULT_ROOM = 'test';

var SYNC_DELAY = 0;

// TODO: how about we pass encodedState und updateStateFunc directly?
// -> less assumptions necessary
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(210);
  } catch (e) { }
}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(97)(module), __webpack_require__(0)))
...
exports.syncState = undefined;

var _syncState2 = __webpack_require__(104);

var _syncState3 = _interopRequireDefault(_syncState2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.syncState = _syncState3.default;
